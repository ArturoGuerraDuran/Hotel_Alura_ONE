...
public class RegistroHuesped extends JFrame {
	...
	private void guardarHuesped() {
		...
		String Fecha_de_nacimiento=((JTextField)txtFechaN.getDateEditor().getUiComponent()).getText();
		int nreserva= Integer.parseInt(txtNreserva.getText());
		String telefono= txtTelefono.getText();
		
		ModeloHuespedes modeloHuespedes=new ModeloHuespedes(txtNombre.getText(), txtApellido.getText(), java.sql.Date.valueOf(Fecha_de_nacimiento),txtNacionalidad.getSelectedItem().toString(),telefono,nreserva);
		this.huespedController.guardar(modeloHuespedes);
